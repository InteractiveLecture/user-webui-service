...
describe('CallBackend', function() {
  var service: lectureDefinitions.interfaces.backendable;
  ...
  beforeEach(module('webUiService'));

  beforeEach(inject(function(CallBackendService: lectureDefinitions.interfaces.backendable, $httpBackend: ng.IHttpBackendService) {
    this.service = CallBackendService;
    this.httpBackend = $httpBackend
    this.httpBackend.when('POST', '/login').respond(true)
  ...
  it('should post userData to /login', function() {
